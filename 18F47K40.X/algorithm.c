...
//---------------------------------------------------------------------------
unsigned short CRC16(const unsigned char *bMemory, unsigned short len)
{
	unsigned short n;
...
{
    ulong poly = CRC32_POLY;
    ulong crc = CRC32_INIT;
    ulong tmp2,tmp1;
    //msg_size >>=2;        //Divido per 4: posso mettere size in byte, non in DWORD
...
{
    const unsigned long poly = CRC32_POLY;
